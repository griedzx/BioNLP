...
querywords= input("Please enter the keywords separated by a space: ").split()
print ("We are returning all filtered sentences which included the key words, \"{0}\", \
